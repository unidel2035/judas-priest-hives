...
class SSHTunnelApp:
    ...
    def setup_tray_icon(self):
        ...
        # Не создаем иконку при инициализации - только при сворачивании
        # Биндим сворачивание в трей (только для закрытия окна)
        self.root.protocol("WM_DELETE_WINDOW", self.hide_to_tray)
        # Убираем автосворачивание при сворачивании окна - это вызывает проблемы
    ...
    def setup_ui(self):
        ...
        # Tray control button
        ttk.Button(button_frame, text="Hide to Tray", command=self.hide_to_tray).pack(
